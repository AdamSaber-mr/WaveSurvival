...
| 11b | Polish: parkmedewerker-zombies (variatie, geen naamplaten), wapens v2 (14-18 delen + Muzzle), first person + sprint + crosshair | ✅ Klaar |
| 11c | Polish: viewmodel met handen (sway/bob/recoil/reload-animatie), mondingsvuur, bloed-effecten, bloedscherm | ✅ Klaar |
| 11d | Polish: geluid (wapens, zombies, muziek) | ⏭️ Volgende |
